...
#### （２）DAO名称
- 論理名：AKD02010(試合属性（更新）)
- 物理名：Aki02010MatchInfoUpdateDao
- ファイル名：aki02010-match-info-update.dao.ts

#### （３）パッケージ
app\akc02000\infrastructure\aki02010
...
update t_matches
   set matchDateTime   =  :matchDateTime,
       matchName       =  :matchName,
       matchType       =  :matchType,
       singlesPlayer1  =  :singlesPlayer1,
       singlesPlayer2  =  :singlesPlayer2,
       doublesPlayerA1 =  :doublesPlayerA1,
       doublesPlayerA2 =  :doublesPlayerA2,
       doublesPlayerB1 =  :doublesPlayerB1,
       doublesPlayerB2 =  :doublesPlayerB2,
       matchSetting    =  :matchSetting,
       setType         =  :setType,
       gameFinalType   =  :gameFinalType,
...
#### （２）入力パラメータ名称
- 論理名：AKI02010(試合属性（更新）)
- 物理名：Aki02010MatchInfoUpdateRequestDto
- ファイル名：aki02010-match-info-update-request.dto.ts
...
#### （２）出力パラメータ名称
- 論理名：AKI02010(試合属性（更新）)
- 物理名：Aki02010MatchInfoUpdateResponseDto
- ファイル名：aki02010-match-info-update-response.dto.ts
