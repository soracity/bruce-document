...
#### （２）DAO名称
- 論理名：BRI1002(試合属性一覧取得)
- 物理名：Bri1002MatchInfoSelectAllDao
- ファイル名：bri1002-match-info-select-all-dao.ts

#### （３）パッケージ
app\brf1000\brf1002\infrastructure\dao-generate
...
#### （３）入力パラメータパッケージ
app\brf1000\brf1002\infrastructure\dto-generate
...
#### （２）出力パラメータ名称
- 論理名：BRI1002(試合属性一覧取得)
- 物理名：Bri1002MatchInfoSelectAllResDto
- ファイル名：bri1002-match-info-select-all-res-dto.ts
