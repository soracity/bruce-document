...
#### （２）DAO名称
- 論理名：BRI9010(ラベル言語一覧取得)
- 物理名：Bri9010LabelLanguageSelectDao
- ファイル名：bri9010-label-language-select.dao.ts
...
#### （２）入力パラメータ名称
- 論理名：BRI9010(ラベル言語一覧取得)
- 物理名：Bri9010LabelLanguageSelectReqDto
- ファイル名：bri9010-label-language-select-req.dto.ts
...
#### （２）出力パラメータ名称
- 論理名：BRI9010(ラベル言語一覧取得)
- 物理名：Bri9010LabelLanguageSelectResDto
- ファイル名：bri9010-label-language-select-res.dto.ts
