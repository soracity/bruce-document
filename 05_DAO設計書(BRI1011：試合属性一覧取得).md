...
#### （２）DAO名称
- 論理名：BRI1011(試合属性一覧取得)
- 物理名：Bri1011MatchInfoSelectAllDao
- ファイル名：bri1011-match-info-select-all-dao.ts

#### （３）パッケージ
app\brf1000\brf1011\infrastructure\dao-generate
...
#### （３）入力パラメータパッケージ
app\brf1000\brf1011\infrastructure\dto-generate
...
#### （２）出力パラメータ名称
- 論理名：BRI1011(試合属性一覧取得)
- 物理名：Bri1011MatchInfoSelectAllResDto
- ファイル名：bri1011-match-info-select-all-res-dto.ts
