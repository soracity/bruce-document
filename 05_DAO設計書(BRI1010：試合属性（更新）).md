...
#### （２）DAO名称
- 論理名：BRI1010(試合属性（更新）)
- 物理名：Bri1010MatchInfoUpdateDao
- ファイル名：bri1010-match-info-update.dao.ts


#### （３）パッケージ
app\brf1000\brf1010\infrastructure\dao-generate
...
#### （２）入力パラメータ名称
- 論理名：BRI1010(試合属性（更新）)
- 物理名：Bri1010MatchInfoUpdateReqDto
- ファイル名：bri1010-match-info-update-req.dto.ts


#### （３）入力パラメータパッケージ
app\brf1000\brf1010\infrastructure\dto-generate
...
#### （２）出力パラメータ名称
- 論理名：BRI1010(試合属性（更新）)
- 物理名：Bri1010MatchInfoUpdateResDto
- ファイル名：bri1010-match-info-update-res.dto.ts
