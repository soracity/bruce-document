...
#### （２）DAO名称
- 論理名：BRI9010(ラベルキー一覧取得)
- 物理名：Bri9010LabelKeySelectDao
- ファイル名：bri9010-label-key-select.dao.ts
...
#### （２）入力パラメータ名称
- 論理名：BRI9010(ラベルキー一覧取得)
- 物理名：Bri9010LabelKeySelectReqDto
- ファイル名：bri9010-label-key-select-req.dto.ts
...
#### （２）出力パラメータ名称
- 論理名：BRI9010(ラベルキー一覧取得)
- 物理名：Bri9010LabelKeySelectResDto
- ファイル名：bri9010-label-key-select-res.dto.ts
